component persistent="true" table="migration" {
	...
	property name="versionFrom" fieldtype="one-to-one" cfc="version" fkcolumn="version_from_id";
	property name="versionTo" fieldtype="one-to-one" cfc="version" fkcolumn="version_to_id";
